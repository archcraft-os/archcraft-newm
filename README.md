...
- If you are using **`Archcraft`** (`Required: 2023 or later`) as your OS, You can just install the provided package with : `sudo pacman -U archcraft-newm-5.0-1-any.pkg.tar.zst` or `sudo pacman -U archcraft-newm-blur-5.0-1-any.pkg.tar.zst`, Whichever you want to use.
